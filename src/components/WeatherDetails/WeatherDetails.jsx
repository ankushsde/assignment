  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `https://api.weatherbit.io/v2.0/history/energy?city=${name}&start_date=2024-03-03&end_date=2024-03-10&threshold=63&units=I&key=8ff6b1c427824112b02b9f92f1485bbb&tp=daily`
      );
      if (!response.ok) {
